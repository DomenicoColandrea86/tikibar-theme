		...
		<section class="tiki-section grid-1-2 single-blog-post">
			...
			<article class="module ticket-module">
				...
				<div class="sb-circle3"></div><div class="sb-circle4"></div>
					...
					<section id="tikimenu-title" class="latest-news grid-1-2 events-wrapper">

					<h1 class="site-section-title tikimenu-title"><span>l</span>Tiki Menu</h1>

						<article class="module group tikimenu-title-module">

							<div class="circle1"></div><div class="circle2"></div>

							<h1 class="tikimenu-h1">Martell's Tiki Bar Menu</h1><br>

							<a href="http://tikibartheme.whatup/wp-content/themes/tikibar%20v1/pdfs/Martell's_2013Online_outdoormenu.pdf" class="tikimenu-link">Click Here to download Tiki Bar 2013 Menu</a>

							<div class="circle3"></div><div class="circle4"></div>
							
						</article>
						<br><br>
				</section> <!-- END Section tiki menu -->
